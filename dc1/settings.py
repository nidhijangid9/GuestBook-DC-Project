...
SECRET_KEY = 'django-insecure-6f@at=#1wb!y(v8jtj!b6j*a6g*186%+0gz#7vxci&3woic2'
...
MIDDLEWARE = [
    ...
    'myapp.rpc_middleware.RPCMiddleware',
]
...
tmpPostgres = urlparse(os.getenv("DATABASE_URL", "postgres://postgres:nidhi@localhost:5432/"))
# print(tmpPostgres)
DATABASES = {
    'default': {
...
# Cache configuration for time offsets
CACHES = {
    'default': {
